<?php
// Generate a per-response CSP nonce and send header BEFORE any output.
$nonce = base64_encode(random_bytes(16));
header("Content-Security-Policy: script-src 'self' 'nonce-$nonce'; object-src 'none'; base-uri 'self';");
